window.onload = () => {
  ...
  const tabComunication = new BroadcastChannel(
    `${storagePrefix}tabComunication`
  );
  ...
  var listHeadHiglightField = document.querySelector(
    "#list-head-higlight-field"
  );
  ...
  // screen
  var screenWidth = () =>
    document.querySelector("#options-change-screen-width");
  var screenHeight = () =>
    document.querySelector("#options-change-screen-height");
  var screenBgColor = () =>
    document.querySelector("#options-change-screen-bg-color");
  ...
  var listBgColor = () =>
    document.querySelector("#options-change-list-bg-color");
  var listVerticalPosition = () =>
    document.querySelector("#options-list-vertical-position");
  var listHorizontalPosition = () =>
    document.querySelector("#options-list-horizontal-position");
  var listMarginTop = () => document.querySelector("#options-list-margin-top");
  var listMarginbottom = () =>
    document.querySelector("#options-list-margin-bottom");
  var listMarginRight = () =>
    document.querySelector("#options-list-margin-right");
  var listMarginLeft = () =>
    document.querySelector("#options-list-margin-left");

  // list title
  var activeTitle = () => document.querySelector("#options-list-title-active");
  var titleText = () =>
    document.querySelector("#options-change-list-title-text");
  var titleFontSize = () =>
    document.querySelector("#options-change-list-title-font-size");
  var titleFontColor = () =>
    document.querySelector("#options-change-list-title-font-color");
  var titleBgColor = () =>
    document.querySelector("#options-change-list-title-bg-color");

  // list header
  var activeListHeader = () =>
    document.querySelector("#options-list-header-active");
  var listHeaderName1 = () =>
    document.querySelector("#options-change-list-header-name1");
  var listHeaderName2 = () =>
    document.querySelector("#options-change-list-header-name2");
  var listHeaderFontSize = () =>
    document.querySelector("#options-change-list-header-font-size");
  var listHeaderFontColor = () =>
    document.querySelector("#options-list-header-font-color");
  var listHeaderBgColor = () =>
    document.querySelector("#options-list-header-bg-color");

  // list items
  var activeListIndex = () =>
    document.querySelector("#options-list-header-show-index");
  var itemDefaultColor = () =>
    document.querySelector("#options-change-list-item-color");
  var itemFontSize = () =>
    document.querySelector("#options-list-item-font-size");

  // higlight
  var higlightFontSize = () =>
    document.querySelector("#options-higlight-font-size");
  var higlightFontColor = () =>
    document.querySelector("#options-higlight-font-color");
  var higlightBgColor = () =>
    document.querySelector("#options-higlight-bg-color");

  //animations
  var animationAddItem = () =>
    document.querySelector("#options-animations-add-item");
  var animationAddItemType = () =>
    document.querySelector("#options-animations-add-item-type");
  var animationRemoveItem = () =>
    document.querySelector("#options-animations-remove-item");
  var animationRemoveItemType = () =>
    document.querySelector("#options-animations-remove-item-type");
  var animationChangePosition = () =>
    document.querySelector("#options-animations-change-position");

  //automation
  var twitchChannel = () =>
    document.querySelector("#automation-twitch-channel");
  ...
  var removeItemCommand = () =>
    document.querySelector("#automation-remove-item-command");
  ...
  function updatePanelInterface() {
    ...
    animationChangePosition().checked =
      options.animations.changePositionAnimation;
  ...
  function editFields() {
    ...
    for (let i = 0; i < editableFields.length; i++) {
      editableFields[i].onchange = (event) => {
        let id = event.currentTarget.getAttribute("unique");
        field = event.currentTarget.getAttribute("field");
        let newValue = event.currentTarget.value;

       itemToChange = list.findIndex(s => s.id === id)

       if(itemToChange >=0){
           list[itemToChange][field] = newValue
  ...
  btn_addListItem.onclick = (event) => {
    ...
    higlightSub().checked
      ? (let = higlightSubs = true)
      : (let = higlightSubs = false);
    higlightVip().checked
      ? (let = higlightVips = true)
      : (let = higlightVips = false);
    higlightBit().checked
      ? (let = higlightBits = true)
      : (let = higlightBits = false);
    ...
    list.forEach((listItem, index) => {
      tableBodyHTML += `
                <tr ${listItem.higlight ? `class="table-warning"` : ""}>
                    ...
                    <td><input class="editable" type="text" unique="${listItem.id}" field="firstField"  value="${listItem.firstField}"></td>
                    <td><input class="editable" type="text" unique="${listItem.id}" field="secondField"  value="${listItem.secondField}"></td>
  ...
  function addItemToList(item) {
    //console.log(item)
    item["id"] =
      item.firstField.replace(/\s+/g, "") +
      item.secondField.replace(/\s+/g, "") +
  ...
  function handleTwitchCommand(user, command, message, flags, extra) {
    ...
    if (
      command === options.automation.addItemCommand &&
    ...
    if (
      command === options.automation.removeItemCommand &&
      (flags.broadcaster || flags.mod)
    ) {
